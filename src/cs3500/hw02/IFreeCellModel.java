...
/**
 * This is the interface of the Freecell model. It is parameterized over the card type
 */
public interface IFreeCellModel<K> {
   ...
   * method first verifies that the deck is valid.
   *
   * <p>
   * It deals the deck among the cascade piles in round-robin fashion. Thus if there are 4 cascade
   * piles, the 1st pile will get cards 0, 4, 8, ..., the 2nd pile will get cards 1, 5, 9, ..., the
   * 3rd pile will get cards 2, 6, 10, ... and the 4th pile will get cards 3, 7, 11, ....
   * </p>
   *
   * <p>
   * Depending on the number of cascade piles, they may have a different number of cards
   * </p>
   *
   ...
   * 
   * <p>
   * where [b] is a single space, [n] is newline. Note that there is no newline on the last line. If
   * a pile has no cards in it, there should be no space character after the colon and before the
   * newline.
   * </p>
   */
  String getGameState();
